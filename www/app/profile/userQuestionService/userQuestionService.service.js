...
function userQuestionService($q, dataService) {
  ...
  function getAllQuestions(userId) {
    ...
    if (!_.isEmpty(userQuestions)) {
      deferred.resolve(userQuestions);
      return deferred.promise;
    }

    dataService.getAllQuestions(userId)
      .then(function(result) {
        userQuestions.myQuestionsActive = myQuestionsActive;
        userQuestions.myQuestionsOld = myQuestionsOld;
        userQuestions.friendQuestionsActive = friendQuestionsActive;
        userQuestions.friendQuestionsOld = friendQuestionsOld;
